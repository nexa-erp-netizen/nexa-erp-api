...
const DESCRICOES_PAGINAS_NAVEGACAO = {
  ...
  Funcionários: "funcionários e vínculos trabalhistas dos clientes",
  "Folha de Pagamento": "processamento e fechamento da folha",
  "Pró-labore": "cálculo e recibos de pró-labore",
  Férias: "controle, cálculo e recibos de férias",
  "Calculadora de Rescisão": "cálculo e demonstrativo de rescisão",
  ...
  "Conciliação Bancária": "importação, classificação e conciliação de extratos",
  "NF-e": "emissão e controle de notas fiscais eletrônicas",
  "NFS-e": "emissão e controle de notas fiscais de serviço",
  ...
  "Escritórios Nexa": "gestão protegida dos escritórios da plataforma",
  Agenda: "agenda e compromissos",
  "Google Drive": "arquivos e integração com o Google Drive",
...
const PAGINAS_POR_PERFIL = {
  ...
  Funcionário: new Set([
    "Dashboard", "Notificações", "Escritório Digital", "Clientes", "Funcionários", "Folha de Pagamento",
    "Pró-labore", "Férias", "Calculadora de Rescisão", "Lançamentos Contábeis", "Conciliação Bancária", "NF-e", "NFS-e",
    ...
    "Radar Inteligente", "Relatórios", "Calculadora IRPF MEI", "Agenda", "Google Drive", "Sobre",
  ]),
...
async function conversar(req, res) {
  ...
  try {
    ...
    if (modoDesenvolvedor) {
      ...
      const respostaLiteralDesenvolvedor = ["nexa-dev-github", "nexa-dev-codigo", "nexa-dev-diagnostico", "nexa-dev-leitura", "nexa-dev-conversa"].includes(modoDesenvolvedor.modo)
